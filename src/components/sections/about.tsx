          ...
          <div className="lg:col-span-3 space-y-6">
            <Card>
              ...
              <CardContent className="text-muted-foreground space-y-4">
                <p>
                  I&apos;ve always been passionate about technology, even before I knew what a software engineer did. I always wanted to be one. My journey began in a residential school where personal gadgets were off-limits. The only tech access we had was during computer class, where media playback was restricted. As a music lover, this was a challenge I was determined to overcome.
                </p>
                <p>
